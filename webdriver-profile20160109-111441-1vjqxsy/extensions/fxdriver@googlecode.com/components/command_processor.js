...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", k = e[g] || "", q = /(\d*)(\D*)/g, n = /(\d*)(\D*)/g;
    do {
      var l = q.exec(h) || ["", "", ""], r = n.exec(k) || ["", "", ""];
...
bot.dom.getOverflowState = function(a, b) {
  ...
  var f = bot.dom.getClientRect(a), g = goog.dom.getOwnerDocument(a), h = g.documentElement, k = g.body;
  if(!k) {
    return bot.dom.OverflowState.NONE
  }
  var q = bot.dom.getEffectiveStyle(h, "overflow"), n, l, r, p, m;
  b ? (l = p = f.left + b.x, r = m = f.top + b.y) : (l = f.left, r = f.top, p = f.left + f.width, m = f.top + f.height);
  for(f = c(a);f;f = c(f)) {
    var s = d(f);
    if("visible" != s.x || "visible" != s.y) {
      ...
      if(u && "visible" != s.x || v && "visible" != s.y) {
        l = e(f);
        r = m < t.top - l.y;
        if(p < t.left - l.x && "visible" != s.x || r && "visible" != s.x) {
          return bot.dom.OverflowState.HIDDEN
        }
      ...
      if(u && "visible" != s.x || t && "visible" != s.y) {
        if(n && (p = e(f), l >= h.scrollWidth - p.x || r >= h.scrollHeight - p.y)) {
          return bot.dom.OverflowState.HIDDEN
        }
        p = bot.dom.getOverflowState(f);
        return p == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), n = parseFloat(c[3]), l = parseFloat(c[4]), r = parseFloat(c[5]), c = parseFloat(c[6]), p = f.left + f.width, m = f.top + f.height, s = f.left * d, d = p * d, t = f.left * e, e = p * e, u = f.top * n, n = m * n, v = f.top * l, p = m * l, m = s + u + r, l = t + v + c, u = d + u + r, v = e + v + c, s = s + n + r, t = t + p + c, r = d + n + r, c = e + p + c;
      f.left = Math.min(m, u, s, r);
      f.top = Math.min(l, v, t, c);
      r = Math.max(m, u, s, r);
      c = Math.max(l, v, t, c);
      f.width = r - f.left;
      f.height = c - f.top
      ...
      if("area" == a.tagName.toLowerCase()) {
        ...
        if("poly" == a.shape) {
          for(var q = Number(f[0]), n = Number(f[1]), e = q, g = n, d = 0;d < f.length / 2;d++) {
            var l = Number(f[2 * d]), r = Number(f[2 * d + 1]), q = Math.min(q, l), n = Math.min(n, r), e = Math.max(e, l), g = Math.max(g, r)
          }
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), k = b.touches == b.changedTouches ? h : e(b.touches), q = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), n;
  bot.events.BROKEN_TOUCH_API_ ? (n = f.createEvent("MouseEvents"), n.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), n.touches = k, n.targetTouches = q, n.changedTouches = h, n.scale = b.scale, n.rotation = b.rotation) : (n = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? n.initTouchEvent(k, q, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : n.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, k, q, h, b.scale, b.rotation), n.relatedTarget = b.relatedTarget);
  return n
};
...
function injectAndExecuteScript(a, b, c, d) {
  ...
  var r = this, p = function() {
    ...
    if(bot.userAgent.isProductVersion(4)) {
      for(var b = 0;b < h.length;b++) {
        if("object" === goog.typeOf(h[b])) {
          var d = Object.keys(h[b]), k;
          for(k in d) {
            void 0 == h[b].__exposedProps__ && (h[b].__exposedProps__ = {}), h[b].__exposedProps__[d[k]] = "rw"
          }
        }
      }
    }
    ...
    var l = function(b) {
      e.removeEventListener("webdriver-evaluate-response", l, !0);
    ...
    e.addEventListener("webdriver-evaluate-response", l, !0);
...
FirefoxDriver.prototype.mouseMove = function(a, b) {
  ...
  if(this.enableNativeEvents) {
    a: {
      ...
      var q = (d = a.session.isMousePressed()) ? c : h, n = Utils.getBrowserSpecificOffset(a.session.getBrowser()), l = q.x + n.x, q = q.y + n.y, r = Utils.getNativeMouse(), p = Utils.getNodeForNativeEvents(g);
      if(e && r && p) {
        var e = a.session.getMousePosition(), m = e.x + n.x, n = e.y + n.y;
        fxdriver.logging.info("Moving from (" + e.x + ", " + e.y + ") to (" + h.x + ", " + h.y + ")");
        r.mouseMove(p, m, n, l, q);
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for(var h = 1;h <= d;h++) {
    var k = Math.floor(h * b / d), q = Math.floor(h * c / d), n = bot.dom.getClientRect(a), k = new goog.math.Coordinate(e.x + g.left + k - n.left, e.y + g.top + q - n.top);
    f.move(a, k)
  }
  f.releaseButton()
};
...
var WebElement = {elementEquals:function(a, b) {
  ...
  n = Utils.getLocation(d, "A" == d.tagName), g = n.width ? Math.floor(n.width / 2) : 0, l = n.height ? Math.floor(n.height / 2) : 0;
  if(!q && this.enableNativeEvents && e && f && h && k) {
    ...
    n = bot.action.scrollIntoView(d, new goog.math.Coordinate(g, l));

...
bot.dom.getOverflowState = function(a, b) {
  ...
  var p = bot.dom.getEffectiveStyle(h, "overflow"), r, k, q, n, m;
  b ? (k = n = f.left + b.x, q = m = f.top + b.y) : (k = f.left, q = f.top, n = f.left + f.width, m = f.top + f.height);
  for(f = c(a);f;f = c(f)) {
    var s = d(f);
    if("visible" != s.x || "visible" != s.y) {
      ...
      if(u && "visible" != s.x || v && "visible" != s.y) {
        k = e(f);
        q = m < t.top - k.y;
        if(n < t.left - k.x && "visible" != s.x || q && "visible" != s.x) {
          return bot.dom.OverflowState.HIDDEN
        }
      ...
      if(u && "visible" != s.x || t && "visible" != s.y) {
        if(r && (n = e(f), k >= h.scrollWidth - n.x || q >= h.scrollHeight - n.y)) {
          return bot.dom.OverflowState.HIDDEN
        }
        n = bot.dom.getOverflowState(f);
        return n == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), r = parseFloat(c[3]), k = parseFloat(c[4]), q = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, s = f.left * d, d = n * d, t = f.left * e, e = n * e, u = f.top * r, r = m * r, v = f.top * k, n = m * k, m = s + u + q, k = t + v + c, u = d + u + q, v = e + v + c, s = s + r + q, t = t + n + c, q = d + r + q, c = e + n + c;
      f.left = Math.min(m, u, s, q);

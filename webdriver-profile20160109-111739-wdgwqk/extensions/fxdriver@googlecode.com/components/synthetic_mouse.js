...
bot.dom.getOverflowState = function(a, b) {
  ...
  var p = bot.dom.getEffectiveStyle(h, "overflow"), q, k, r, n, m;
  b ? (k = n = f.left + b.x, r = m = f.top + b.y) : (k = f.left, r = f.top, n = f.left + f.width, m = f.top + f.height);
  for(f = c(a);f;f = c(f)) {
    var s = d(f);
    if("visible" != s.x || "visible" != s.y) {
      var t = bot.dom.getClientRect(f), u = n < t.left, v = m < t.top;
      ...
      if(u && "visible" != s.x || v && "visible" != s.y) {
        k = e(f);
        r = m < t.top - k.y;
        if(n < t.left - k.x && "visible" != s.x || r && "visible" != s.x) {
          return bot.dom.OverflowState.HIDDEN
        }
        n = bot.dom.getOverflowState(f);
        return n == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
      }
      u = k >= t.left + t.width;
      t = r >= t.top + t.height;
      ...
      if(u && "visible" != s.x || t && "visible" != s.y) {
        if(q && (n = e(f), k >= h.scrollWidth - n.x || r >= h.scrollHeight - n.y)) {
          return bot.dom.OverflowState.HIDDEN
        }
        n = bot.dom.getOverflowState(f);
        return n == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), q = parseFloat(c[3]), k = parseFloat(c[4]), r = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, s = f.left * d, d = n * d, t = f.left * e, e = n * e, u = f.top * q, q = m * q, v = f.top * k, n = m * k, m = s + u + r, k = t + v + c, u = d + u + r, v = e + v + c, s = s + q + r, t = t + n + c, r = d + q + r, c = e + n + c;
    ...
    for(var p = c.toUpperCase(), q = 0;q < c.length;q++) {
      ...
      if("\ue000" == k) {
        ...
        if(r) {
          ...
          Utils.keyEvent(a, b, "keypress", k, n, e, r || h, l, d, !s);
  ...
  try {
    ...
    if(c.width) {
      if("area" == a.tagName.toLowerCase()) {
        ...
        if("poly" == a.shape) {
          for(var p = Number(f[0]), q = Number(f[1]), e = p, g = q, d = 0;d < f.length / 2;d++) {
            var k = Number(f[2 * d]), r = Number(f[2 * d + 1]), p = Math.min(p, k), q = Math.min(q, r), e = Math.max(e, k), g = Math.max(g, r)
          }
          return{x:c.left + p, y:c.top + q, width:e - p, height:g - q}
        }
      }
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  bot.events.BROKEN_TOUCH_API_ ? (q = f.createEvent("MouseEvents"), q.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), q.touches = l, q.targetTouches = p, q.changedTouches = h, q.scale = b.scale, q.rotation = b.rotation) : (q = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? q.initTouchEvent(l, p, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : q.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, l, p, h, b.scale, b.rotation), q.relatedTarget = b.relatedTarget);
  return q
};

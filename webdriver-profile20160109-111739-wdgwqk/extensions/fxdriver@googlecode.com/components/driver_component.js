...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", l = e[g] || "", q = /(\d*)(\D*)/g, n = /(\d*)(\D*)/g;
    do {
      var k = q.exec(h) || ["", "", ""], r = n.exec(l) || ["", "", ""];
      if(0 == k[0].length && 0 == r[0].length) {
        break
      }
      var c = 0 == k[1].length ? 0 : parseInt(k[1], 10), p = 0 == r[1].length ? 0 : parseInt(r[1], 10), c = goog.string.compareElements_(c, p) || goog.string.compareElements_(0 == k[2].length, 0 == r[2].length) || goog.string.compareElements_(k[2], r[2])
    }while(0 == c)
  }
  return c
};
...
bot.dom.isShown = function(a, b) {
  ...
  function d(a) {
    return goog.userAgent.IE ? !1 : a.hasAttribute && a.hasAttribute("hidden") ? !0 : (a = bot.dom.getParentElement(a)) && d(a)
  }
  function e(a) {
  ...
  function f(a) {
    return bot.dom.getOverflowState(a) == bot.dom.OverflowState.HIDDEN && goog.array.every(a.childNodes, function(a) {
      return!bot.dom.isElement(a) || f(a)
    })
  }
...
bot.dom.getOverflowState = function(a, b) {
  ...
  var f = bot.dom.getClientRect(a), g = goog.dom.getOwnerDocument(a), h = g.documentElement, l = g.body;
  if(!l) {
    return bot.dom.OverflowState.NONE
  }
  var q = bot.dom.getEffectiveStyle(h, "overflow"), n, k, r, p, m;
  b ? (k = p = f.left + b.x, r = m = f.top + b.y) : (k = f.left, r = f.top, p = f.left + f.width, m = f.top + f.height);
  for(f = c(a);f;f = c(f)) {
    var s = d(f);
    if("visible" != s.x || "visible" != s.y) {
      var t = bot.dom.getClientRect(f), u = p < t.left, v = m < t.top;
      if(u && "hidden" == s.x || v && "hidden" == s.y) {
        return bot.dom.OverflowState.HIDDEN
      }
      if(u && "visible" != s.x || v && "visible" != s.y) {
        k = e(f);
        r = m < t.top - k.y;
        if(p < t.left - k.x && "visible" != s.x || r && "visible" != s.x) {
          return bot.dom.OverflowState.HIDDEN
        }
        p = bot.dom.getOverflowState(f);
        return p == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
      }
      u = k >= t.left + t.width;
      t = r >= t.top + t.height;
      if(u && "hidden" == s.x || t && "hidden" == s.y) {
        return bot.dom.OverflowState.HIDDEN
      }
      if(u && "visible" != s.x || t && "visible" != s.y) {
        if(n && (p = e(f), k >= h.scrollWidth - p.x || r >= h.scrollHeight - p.y)) {
          return bot.dom.OverflowState.HIDDEN
        }
        p = bot.dom.getOverflowState(f);
        return p == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), n = parseFloat(c[3]), k = parseFloat(c[4]), r = parseFloat(c[5]), c = parseFloat(c[6]), p = f.left + f.width, m = f.top + f.height, s = f.left * d, d = p * d, t = f.left * e, e = p * e, u = f.top * n, n = m * n, v = f.top * k, p = m * k, m = s + u + r, k = t + v + c, u = d + u + r, v = e + v + c, s = s + n + r, t = t + p + c, r = d + n + r, c = e + p + c;
      f.left = Math.min(m, u, s, r);
  ...
  goog.userAgent.IE && (c = goog.dom.getOwnerDocument(a), f.left -= c.documentElement.clientLeft + c.body.clientLeft, f.top -= c.documentElement.clientTop + c.body.clientTop);
...
bot.dom.scrollElementRegionIntoContainerView_ = function(a, b, c) {
  var d = bot.dom.getClientRect(a);
  a = bot.dom.getClientRect(c);
  var e = goog.style.getBorderBox(c), f = d.left + b.left - a.left - e.left, d = d.top + b.top - a.top - e.top, e = a.height - b.height;
  c.scrollLeft += Math.min(f, Math.max(f - (a.width - b.width), 0));
  c.scrollTop += Math.min(d, Math.max(d - e, 0))
};
bot.dom.scrollElementRegionIntoClientView = function(a, b) {
  for(var c = bot.dom.getParentElement(a);c;c = bot.dom.getParentElement(c)) {
    bot.dom.scrollElementRegionIntoContainerView_(a, b, c)
  }
};
...
Utils.type = function(a, b, c, d, e, f, g) {
  ...
  if(d && h && l && q) {
    ...
    Utils.shiftCount = 0;
    for(var q = c.toUpperCase(), n = 0;n < c.length;n++) {
      var k = c.charAt(n);
      if("\ue000" == k) {
        ...
        "\ue008" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, r = (h = !h) ? "keydown" : "keyup") : "\ue009" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_CONTROL, r = (e = !e) ? "keydown" : "keyup") : "\ue00a" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ALT, r = (l = !l) ? "keydown" : "keyup") : "\ue03d" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_META, r = (d = !d) ? "keydown" : "keyup") : "\ue00b" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAUSE : 
        "\ue00c" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ESCAPE : "\ue00d" == k ? m = p = 32 : "\ue00e" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAGE_UP : "\ue00f" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAGE_DOWN : "\ue010" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_END : "\ue011" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_HOME : "\ue012" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_LEFT : "\ue013" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_UP : 
        "\ue014" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_RIGHT : "\ue015" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DOWN : "\ue016" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_INSERT : "\ue017" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DELETE : "\ue018" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SEMICOLON, p = 59) : "\ue019" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_EQUALS, p = 61) : "\ue01a" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD0, 
        p = 48) : "\ue01b" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD1, p = 49) : "\ue01c" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD2, p = 50) : "\ue01d" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD3, p = 51) : "\ue01e" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD4, p = 52) : "\ue01f" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD5, p = 53) : "\ue020" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD6, 
        p = 54) : "\ue021" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD7, p = 55) : "\ue022" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD8, p = 56) : "\ue023" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_NUMPAD9, p = 57) : "\ue024" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_MULTIPLY, p = 42) : "\ue025" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ADD, p = 43) : "\ue026" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SEPARATOR, 
        p = 44) : "\ue027" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SUBTRACT, p = 45) : "\ue028" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DECIMAL, p = 46) : "\ue029" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_DIVIDE, p = 47) : "\ue031" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F1 : "\ue032" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F2 : "\ue033" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F3 : "\ue034" == k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F4 : 
        ...
        k ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_F12 : "," == k || "<" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_COMMA, p = k.charCodeAt(0)) : "." == k || ">" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PERIOD, p = k.charCodeAt(0)) : "/" == k || "?" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SLASH, p = c.charCodeAt(n)) : "`" == k || "~" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_BACK_QUOTE, p = k.charCodeAt(0)) : "{" == k || "[" == k ? 
        (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_OPEN_BRACKET, p = k.charCodeAt(0)) : "\\" == k || "|" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_BACK_SLASH, p = k.charCodeAt(0)) : "}" == k || "]" == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_CLOSE_BRACKET, p = k.charCodeAt(0)) : "'" == k || '"' == k ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_QUOTE, p = k.charCodeAt(0)) : (m = q.charCodeAt(n), p = c.charCodeAt(n));
        if(r) {
          Utils.keyEvent(a, b, r, m, 0, e, h, l, d, !1)
        }else {
          r = !1;
          p && (r = /[A-Z\!\$\^\*\(\)\+\{\}\:\?\|~@#%&_"<>]/.test(k));
          r && !h && (k = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, Utils.keyEvent(a, b, "keydown", k, 0, e, !0, l, d, !1), Utils.shiftCount += 1);
          k = m;
          if(32 <= p && 127 > p && (k = 0, !r && h && 32 < p)) {
            if(97 <= p && 122 >= p) {
              p = p + 65 - 97
            }else {
          ...
          s = Utils.keyEvent(a, b, "keydown", m, 0, e, r || h, l, d, !1);
          Utils.keyEvent(a, b, "keypress", k, p, e, r || h, l, d, !s);
          Utils.keyEvent(a, b, "keyup", m, 0, e, r || h, l, d, !1);
          r && !h && (k = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, Utils.keyEvent(a, b, "keyup", k, 0, e, !1, l, d, !1))
        }
      }
    }
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, l, q) {
  ...
  g && (q |= 4);
  l && (q |= 8);
  return a.defaultView.QueryInterface(Components.interfaces.nsIInterfaceRequestor).getInterface(Components.interfaces.nsIDOMWindowUtils).sendKeyEvent(c, d, e, q, b)
};
  ...
  try {
    ...
    if(c.width) {
      if("area" == a.tagName.toLowerCase()) {
        ...
        if("poly" == a.shape) {
          for(var q = Number(f[0]), n = Number(f[1]), e = q, g = n, d = 0;d < f.length / 2;d++) {
            var k = Number(f[2 * d]), r = Number(f[2 * d + 1]), q = Math.min(q, k), n = Math.min(n, r), e = Math.max(e, k), g = Math.max(g, r)
          }
          return{x:c.left + q, y:c.top + n, width:e - q, height:g - n}
        }
      }
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), l = b.touches == b.changedTouches ? h : e(b.touches), q = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), n;
  bot.events.BROKEN_TOUCH_API_ ? (n = f.createEvent("MouseEvents"), n.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), n.touches = l, n.targetTouches = q, n.changedTouches = h, n.scale = b.scale, n.rotation = b.rotation) : (n = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? n.initTouchEvent(l, q, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : n.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, l, q, h, b.scale, b.rotation), n.relatedTarget = b.relatedTarget);
  return n
};
...
function injectAndExecuteScript(a, b, c, d) {
  ...
  if(e.designMode && "on" == e.designMode.toLowerCase()) {
    ...
    var l = a.session.getWindow(), l = l.wrappedJSObject, q = new Components.utils.Sandbox(l);
    q.window = l;
    q.document = e.wrappedJSObject ? e.wrappedJSObject : e;
    q.navigator = l.navigator;
    q.__webdriverParams = h;
    try {
      var n = Components.utils.evalInSandbox("with(window) { var __webdriverFunc = function(){" + b.script + "};  __webdriverFunc.apply(null, __webdriverParams); }", q);
      a.value = Utils.wrapResult(n, e);
      a.send();
      return
    }catch(k) {
      throw new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, k);
    }
  }
  var r = this, p = function() {
    ...
    if(bot.userAgent.isProductVersion(4)) {
      for(var b = 0;b < h.length;b++) {
        if("object" === goog.typeOf(h[b])) {
          var d = Object.keys(h[b]), l;
          for(l in d) {
            void 0 == h[b].__exposedProps__ && (h[b].__exposedProps__ = {}), h[b].__exposedProps__[d[l]] = "rw"
          }
        }
      }
    }
    f.__webdriver_evaluate.args = h;
...
FirefoxDriver.prototype.findElementInternal_ = function(a, b, c, d, e) {
  ...
  try {
    ...
    var n = goog.bind(this.findElementInternal_, this, a, b, c, d, e);
    this.jsTimer.setTimeout(n, 100)
  }catch(k) {
...
FirefoxDriver.prototype.findElementsInternal_ = function(a, b, c, d, e) {
  ...
  try {
    ...
    if(q && !h.length && goog.now() - e <= q) {
      var n = goog.bind(this.findElementsInternal_, this, a, b, c, d, e);
      this.jsTimer.setTimeout(n, 10)
    }else {
      a.value = g, a.send()
    }
  }catch(k) {
...
FirefoxDriver.prototype.mouseMove = function(a, b) {
  ...
  if(this.enableNativeEvents) {
    a: {
      ...
      var q = (d = a.session.isMousePressed()) ? c : h, n = Utils.getBrowserSpecificOffset(a.session.getBrowser()), k = q.x + n.x, q = q.y + n.y, r = Utils.getNativeMouse(), p = Utils.getNodeForNativeEvents(g);
      if(e && r && p) {
        var e = a.session.getMousePosition(), m = e.x + n.x, n = e.y + n.y;
        fxdriver.logging.info("Moving from (" + e.x + ", " + e.y + ") to (" + h.x + ", " + h.y + ")");
        r.mouseMove(p, m, n, k, q);
        ...
        throw generateErrorForNativeEvents(e, r, p);
      }
    }
    a.send()
  }else {
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for(var h = 1;h <= d;h++) {
    var l = Math.floor(h * b / d), q = Math.floor(h * c / d), n = bot.dom.getClientRect(a), l = new goog.math.Coordinate(e.x + g.left + l - n.left, e.y + g.top + q - n.top);
    f.move(a, l)
  }
  f.releaseButton()
};
...
bot.action.scrollIntoView = function(a, b) {
  ...
  c = b || new goog.math.Coordinate(0, 0);
  c = new goog.math.Rect(c.x, c.y, 1, 1);
  bot.dom.scrollElementRegionIntoClientView(a, c);
...
var WebElement = {elementEquals:function(a, b) {
  ...
  var c = Utils.getElementAt(b.id, a.session.getDocument()), d = fxdriver.moz.unwrapFor4(c), e = Utils.getNativeMouse(), f = Utils.getNodeForNativeEvents(d), g = Components.classes["@mozilla.org/xre/app-info;1"].getService(Components.interfaces.nsIXULAppInfo), h = 0 <= Components.classes["@mozilla.org/xpcom/version-comparator;1"].getService(Components.interfaces.nsIVersionComparator).compare(g.platformVersion, "1.9"), l = Components.classes["@mozilla.org/thread-manager;1"], q = "option" == d.tagName.toLowerCase(), 
  n = Utils.getLocation(d, "A" == d.tagName), g = n.width ? Math.floor(n.width / 2) : 0, k = n.height ? Math.floor(n.height / 2) : 0;
  if(!q && this.enableNativeEvents && e && f && h && l) {
    fxdriver.logging.info("Using native events for click");
    n = goog.dom.getWindow(goog.dom.getOwnerDocument(d));
    for(n = n.frameElement;n;n = n.frameElement) {
      n.scrollIntoView(), n = goog.dom.getWindow(goog.dom.getOwnerDocument(n))
    }
    n = bot.action.scrollIntoView(d, new goog.math.Coordinate(g, k));
    if(!Utils.isSVG(c.ownerDocument) && !n) {
      a.sendError(new WebDriverError(bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS, "Element cannot be scrolled into view:" + c));
      return
    }
    n = Utils.getLocationRelativeToWindowHandle(d, "A" == d.tagName);
    h = n.x + g;
    n = n.y + k;
    try {
      var r = a.session.getMousePosition(), p = new goog.math.Coordinate(h, n), m = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      e.mouseMove(f, r.x + m.x, r.y + m.y, p.x + m.x, p.y + m.y);
      var s = Utils.getPageUnloadedIndicator(d);
      e.click(f, p.x + m.x, p.y + m.y, 1);
      a.session.setMousePosition(p.x, p.y);
...
WebElement.sendKeysToElement = function(a, b) {
  ...
  this.jsTimer.setTimeout(function() {
    ...
    Utils.type(a.session.getDocument(), h, b.value.join(""), l.enableNativeEvents, l.jsTimer, !0);
    a.send()
  }, 0)
};
